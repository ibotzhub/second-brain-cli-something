...
A second brain for developers. Save your ideas, learnings, and insights, then surface them exactly when you need them using semantic search and context awareness. # Brain CLI
...
- `notes.json`: Your notes and metadata (embeddings are regenerated on startup)
